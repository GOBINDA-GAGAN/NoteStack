...
export const resendOtp = async (req, res) => {
    try {
        ...
        const mailMessage = "Thank you for registering with NoteStack. To complete your registration and verify your email address, please use the following verification code:";
